<?php
/**
 * Block template file: parts/blocks/half-hero.php
 *
 * Half Hero Block Template.
 *
...
$id = 'half-hero-' . $block['id'];
if ( ! empty($block['anchor'] ) ) {
    $id = $block['anchor'];
}

// Create class attribute allowing for custom "className" and "align" values.
$classes = 'block-half-hero';
...
<section id="<?php echo $block_id ?>" class="w-full min-h-[400px] lg:min-h-[640px] lg:h-[65vh] 2xl:min-h-[720px] 2xl:h-[70vh] bg-gradient-to-b lg:bg-gradient-to-r from-brand-black to-brand-light_gradient pt-[96px] lg:pt-<?php echo get_field( 'top_spacing' ); ?> pb-<?php echo get_field( 'bottom_spacing' ); ?> lg:px-8">
