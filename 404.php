	...
	<main role="main">
		...
		<section class="h-[90.5vh]">
				<div class="flex flex-col items-center justify-center w-full h-full">
					<h1 class="text-2xl sm:text-5xl xl:text-7xl xl:leading-snug my-4 font-title font-semibold text-brand-darkest_grey text-center"><?php _e( 'Page not found', 'web-ok-starter' ); ?></h1>
